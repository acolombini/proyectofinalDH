        ...
        <div class="container">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse justify-content-end">
                <ul class="navbar-cuerpo nav navbar-nav row text-right">
                    ...
                    <li class="nav-item p-0 ml-2 col ">
                        <a href="{{ route('login') }}" class="nav-link d-flex flex-nowrap align-items-center">
        ...
        <div class="container">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse justify-content-end">
                <ul class="navbar-cuerpo nav navbar-nav row text-right">
                    ...
                    <!-- botones de carrito y login -->
                    <li class="nav-item p-0 ml-2 col dropdown ">
                        <a id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle d-flex flex-nowrap align-items-center">
                            <i class="fas fa-user mr-2"></i>
