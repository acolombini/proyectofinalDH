...
<body>
   <div class="container-fluid m-0 p-0 bg-sky">
      ...
      <main>
         <div class="container cart bg-transparent mb-5"><!--cart-->
            <form class="my-5 p-2 shadow" action="#checkout" method="POST">
               <div class="row d-flex align-items-baseline justify-content-around">
                  <h2 class="d-inline flex-fill mx-4"> My Cart Items </h2>
                  <h3 class="d-inline mx-4"> Total:  <h2 class="d-inline mx-4"> $99999 </h2></h3>
               </div>
               <div class="row justify-content-between p-3">
                  <div class="col-8">
                     <!--cart producto 1-->
                     <div class="row bg-transblack rounded text-light shadow mb-4 p-2">
                  ...
                  <!--SUBMIT-->
                  <div class="col-3 border border-dark bg-transparent shadow">
                     ...
                     <div class="row justify-content-start p-2"> <h5> Detalle de Precio </h5> </div>
                     <div class="row p-2"><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores rerum, labore obcaecati minima perferendis harum sed maiores culpa cum consequatur  </p></div>
            ...
            <!--CHECKOUT-->
            <div class="row p-2 m-0 bg-transparent shadow">
               <div class="row m-2 py-4 justify-content-start border-bottom border-dark flex-fill" id="checkout">
                  <h3>Selecciona un método de pago</h3>
               </div>
               <div class="col-9">
                  <div class="row border-bottom border-dark flex-fill p-3 mb-4"><h5>Tus tarjetas guardadas, de crédito y débito</h5></div>
                  ...
                  <div class="row p-2 mt-2"><h5> Otros métodos de pago </h5></div>
               ...
               <!--SUBMIT-->
               <div class="col p-3">
                  <div class="row justify-content-center p-2 border border-bottom-0 border-dark">
                     <button class="btn btn-info shadow flex-fill mb-4" type="submit">Continuar</button>
                     
                  </div> 
                  <div class="row p-5 text-center border border-top-0 border-dark">
                     <p>
